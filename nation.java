...
/**
 * It rappresents the amount of Covid-19's data through the call "/live/country"
 */
public class nation {
	/**
	...
	public nation (String country, int confirmed, int deaths, int recovered, int active, Date date) {
